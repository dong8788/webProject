...
<body>
	<div style="width:1200px;margin-left:auto;margin-right:auto">
		...
		<form action="${pageContext.request.contextPath}/cs/notice/update/${seq}" method="post">
		<input type="hidden" name="noticeSeq" value="${noticeVo.getNoticeSeq()}">
		<table style="width:100%">
		<tr>
			<th style="width:50px">제목</th>
			<td style="width:500px"><input type="text" name="title" value="${noticeVo.getTitle()}" required="required"></td>
		</tr>
		<tr>
			<th>분류</th>
			<td>
		...
		<tr>
			<th>내용</th>
			<td>
			<textarea name="content" id="editor" style="width:400px; height:200px">${noticeVo.getContent()}</textarea>
			<script>
				ClassicEditor
