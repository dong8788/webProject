	...
	<div style="width:1200px;margin-left:auto;margin-right:auto">
		...
		<tr><th style="width:50px">질문</th>
			<td style="height:100px; width:100px">
				<textarea name="query" id="editor" style="height:200px; width:400px">${faqVo.getQuery()}</textarea>
				<script>
				ClassicEditor
		...
		<tr><th>답변</th>
			<td style="height:100px; width:100px">
				<textarea name="reply" id="editor2" style="height:200px; width:400px">${faqVo.getReply()}</textarea>
				<script>
				ClassicEditor
